...
md"""
# Estimating the trace metal release during the Thomas fire

It's from Rachel's paper!
"""
...
# ╔═╡ ea9f69c6-c746-11ea-2b8f-39a40d84f271
md"Just to show that errorbars are automatically added when using Measurements.jl:"
...
md"""
With Measurements.jl, you can essentially work with `±` (type `\pm` and then `TAB`) in all your variables. And uncertainties are propagated correctly. For example, if you define 
...
# ╔═╡ 86a99dc8-c5a3-11ea-0814-71318b84a505
a - a
...
scatter([v * PM25_release |> t for v in TE_contents], 
	...
	xticks=(1:8, keys(TE_contents)), xlims=(-1,10))
